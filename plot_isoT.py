...
for j in range(NT):
    line0,=ax.plot(r, P[:,j], dashes=[1,0],  lw=0.5, c="lightgray", alpha=1,zorder=1, label='')
...
j=9
line1,=ax.plot(r, P[:,j], dashes=dash[0],  lw=1, c=colors[0], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=19
line2,=ax.plot(r, P[:,j], dashes=dash[1],  lw=1, c=colors[1], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=23
line3,=ax.plot(r, P[:,j], dashes=dash[2],  lw=1, c=colors[2], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=25
line4,=ax.plot(r, P[:,j], dashes=dash[3],  lw=1, c=colors[3], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=28
line5,=ax.plot(r, P[:,j], dashes=dash[4],  lw=1, c=colors[4], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=33
line6,=ax.plot(r, P[:,j], dashes=dash[5],  lw=1, c=colors[5], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=66
line7,=ax.plot(r, P[:,j], dashes=dash[6],  lw=1, c=colors[6], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
...
#=== sortie
fig.savefig("isoT_Prho.png",bbox_inches="tight",dpi=200)
plt.show()
...
for j in range(NT):
    line0,=ax.plot(V, P[:,j], dashes=[1,0],  lw=0.5, c="lightgray", alpha=1,zorder=1, label='')
...
j=9
line1,=ax.plot(V, P[:,j], dashes=dash[0],  lw=1, c=colors[0], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=19
line2,=ax.plot(V, P[:,j], dashes=dash[1],  lw=1, c=colors[1], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=23
line3,=ax.plot(V, P[:,j], dashes=dash[2],  lw=1, c=colors[2], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=25
line4,=ax.plot(V, P[:,j], dashes=dash[3],  lw=1, c=colors[3], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=28
line5,=ax.plot(V, P[:,j], dashes=dash[4],  lw=1, c=colors[4], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=33
line6,=ax.plot(V, P[:,j], dashes=dash[5],  lw=1, c=colors[5], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
j=66
line7,=ax.plot(V, P[:,j], dashes=dash[6],  lw=1, c=colors[6], alpha=1,zorder=1, label='$T=$'+scinot(T[j],1)+' K')
#label='$T={:.1e} [eV]$'.format(T[j])
...
#=== sortie
fig.savefig("isoT_PV.png",bbox_inches="tight",dpi=200)
plt.show()
